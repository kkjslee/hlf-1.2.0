...
CORE_PEER_ADDRESS=peer0.org1.kt.com:7051 peer chaincode install -n $1 -v $2 -p $CHAINCODE_DIR/marbles

CHAINCODE_DIR=github.com/hyperledger/fabric/examples/chaincode/go/src
CORE_PEER_ADDRESS=peer1.org1.kt.com:7051 peer chaincode install -n $1 -v $2 -p $CHAINCODE_DIR/marbles

echo 'Done'

echo 'Instantiate ChainCode'

CORE_PEER_ADDRESS=peer0.org1.kt.com:7051 peer chaincode instantiate -o orderer0.kt.com:7050 \
...
#CORE_PEER_ADDRESS=peer1.org1.kt.com:7051 peer chaincode instantiate -o orderer0.kt.com:7050 \
#--tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/kt.com/orderers/orderer0.kt.com/msp/tlscacerts/tlsca.kt.com-cert.pem \
